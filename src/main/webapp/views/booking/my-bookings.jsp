            ...
            <%@ include file="../navbar.jsp" %>
                ...
                <%@ include file="../navbar.jsp" %>
                    ...
                    <%-- Refund success message --%>
                        <% if ("true".equals(request.getParameter("refunded"))) { %>
                            <div class="container mt-3">
                                <div style="background:rgba(40,167,69,0.15); border:1px solid rgba(40,167,69,0.4);
                    color:#51cf66; border-radius:10px; padding:15px;">
                                    <i class="bi bi-check-circle"></i>
                                    Booking cancelled successfully. Rs. <%= request.getParameter("refundAmount") %>
                                        has been refunded to your account.
                                </div>
                            </div>
                            <% } %>

                                <div class="page-header"> <%-- this already exists --%>
                                                            ...
                                                            <div class="booking-card">
                                                                <div class="row align-items-center">
                                                                    <div class="col-md-8">
                                                                        ...
                                                                        <div class="movie-title">${booking.movieTitle}
                                                                        </div>
                                                                        <div class="booking-info mt-2">
                                                                            <span><i
                                                                                    class="bi bi-building"></i>${booking.theaterName}</span>
                                                                            &nbsp;|&nbsp;
                                                                            <span><i
                                                                                    class="bi bi-display"></i>${booking.screenName}</span>
                                                                            &nbsp;|&nbsp;
                                                                            <span><i
                                                                                    class="bi bi-calendar3"></i>${booking.showDate}</span>
                                                                            &nbsp;|&nbsp;
                                                                            <span><i
                                                                                    class="bi bi-clock"></i>${booking.showTime}</span>
                                                                        </div>
                                                                        <div class="mt-2">
                                                                            <span class="booking-info"><i
                                                                                    class="bi bi-clock-history"></i>Booked:
                                                                                ${booking.bookingDate}</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4 text-md-end mt-3 mt-md-0">
                                                                        <div class="total-amount">Rs.
                                                                            ${booking.totalAmount}</div>
                                                                        <div class="mt-2">
                                                                            <c:choose>
                                                                                <c:when
                                                    ...
                                                    <c:otherwise>
                                                        <div class="empty-state">
                                                            ...
                                                            <a href="${pageContext.request.contextPath}/movies?action=list"
                                                                class="btn mt-3"
                                                                style="background:#e50914; color:#fff; border-radius:25px; padding:10px 30px;">
                                                                Browse Movies
                                                            </a>
                                                        </div>
                                                    </c:otherwise>
