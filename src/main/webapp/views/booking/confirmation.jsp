                        ...
                        <div class="confirmation-card">
                            ...
                            <%-- Payment notice --%>
                                <div class="payment-notice">
                                    ...
                                    Please complete your payment to secure your seats.
                                </div>
                                ...
                                <div class="d-flex gap-2 justify-content-center flex-wrap">
                                    <%-- Pay Now button --%>
                                        <a href="${pageContext.request.contextPath}/payment?action=selectMethod&bookingId=${booking.id}"
                                            class="btn-pay">
                                            <i class="bi bi-credit-card"></i> Pay Now
                                        </a>
                                        <a href="${pageContext.request.contextPath}/booking?action=myBookings"
                                            class="btn-mybookings">
