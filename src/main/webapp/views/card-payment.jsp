...
<nav class="navbar navbar-dark cine-navbar">
    <div class="container">
        <a class="navbar-brand fw-bold" href="${pageContext.request.contextPath}/payment">CineBook</a>
    </div>
</nav>
...
<div class="payment-wrapper">
    ...
    <div class="payment-card">
        ...
        <form id="cardPaymentForm" action="${pageContext.request.contextPath}/card-payment" method="post">
            ...
            <input type="hidden"
                   name="bookingId"
                   value="<%= request.getAttribute("bookingId") != null ? request.getAttribute("bookingId") : "1" %>">

            <div class="mb-3">
                <label class="form-label">Cardholder Name</label>
                <input type="text"
                       class="form-control cine-input"
                       name="cardholderName"
                       id="cardholderName"
                       required>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select cine-input"
                            name="expiryMonth"
                            id="expiryMonth"
                            required>
            ...
            <div class="mb-4">
                ...
                <input type="number"
                       class="form-control cine-input"
                       name="amount"
                       value="<%= request.getAttribute("amount") != null ? request.getAttribute("amount") : "3010.24" %>"
                       readonly>
            </div>

            <button class="btn cine-btn w-100" type="submit">
                Pay Securely
            </button>
