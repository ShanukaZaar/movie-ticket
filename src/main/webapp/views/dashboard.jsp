        ...
        <body>
            ...
            <%@ include file="navbar.jsp" %>
                ...
                <%-- Page Header --%>
                                ...
                                <div class="row g-4 mb-5">
                                    ...
                                    <div class="col-6 col-md-3">
                                        <a href="${pageContext.request.contextPath}/booking?action=myBookings"
                                            class="dash-card">
                                            <span class="card-icon icon-blue"><i
                                        ...
                                        <div class="row g-4">
                                            <div class="col-6 col-md-3">
                                                <a href="${pageContext.request.contextPath}/movies?action=new"
                                                    class="dash-card">
                                                    <span class="card-icon icon-red"><i
                                            ...
                                            <div class="col-6 col-md-3">
                                                <a href="${pageContext.request.contextPath}/theater?action=addShow"
                                                    class="dash-card">
                                            ...
                                            <div class="col-6 col-md-3">
                                                <a href="${pageContext.request.contextPath}/theater?action=addTheater"
                                                    class="dash-card">
                                                    <span class="card-icon icon-yellow"><i
                                                            class="bi bi-building-add"></i></span>
                                                    <h5>Add Theater</h5>
                                                    <p>Add a new theater</p>
                                                </a>
                                            </div>
                                            <div class="col-6 col-md-3">
                                                <a href="${pageContext.request.contextPath}/booking?action=allBookings"
                                                    class="dash-card">
                                                    <span class="card-icon icon-purple"><i
                                            ...
                                            <div class="col-6 col-md-3">
                                                <a href="${pageContext.request.contextPath}/theater?action=list"
                                                    class="dash-card">
                                                    <span class="card-icon icon-teal"><i
                                                            class="bi bi-building-gear"></i></span>
                                                    <h5>Manage Theaters</h5>
                                                    <p>Edit and manage theaters</p>
                                                </a>
                                            </div>
                                            <div class="col-6 col-md-3">
                                                <a href="${pageContext.request.contextPath}/theater?action=screens"
                                                    class="dash-card">
                                                    <span class="card-icon icon-blue"><i
                                            ...
                                            <div class="col-6 col-md-3">
                                                <a href="${pageContext.request.contextPath}/movies?action=list"
                                                    class="dash-card">
                                                    <span class="card-icon icon-red"><i
                                                            class="bi bi-collection-play"></i></span>
                                                    <h5>Manage Movies</h5>
                    ...
                    <footer
                        style="background:#000; border-top:2px solid #e50914; padding:20px 0; text-align:center; color:#555; margin-top:40px;">
