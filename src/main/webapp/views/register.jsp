                    ...
                    <div class="col-md-6">
                        <div class="text-center mb-4">
                            <a href="${pageContext.request.contextPath}/home"
                                style="color:#e50914; font-size:1.8rem; font-weight:900; text-decoration:none;">CineBook</a>
                        </div>
                                        ...
                                        <%-- Registration type selector --%>
                                            ...
                                            <form action="${pageContext.request.contextPath}/register" method="post">
                                                ...
                                                <%-- Admin code field - only shown for admin --%>
                                                    <div class="mb-3" id="adminCodeField"
                                                        ...
                                                        <label><i class="bi bi-shield-lock" style="color:#e50914;"></i>
                                                            Admin Secret Code</label>
                                                        <input type="password" name="adminCode" class="form-control"
                                                            placeholder="Enter admin secret code">
                                                        <small style="color:#aaa;">Contact your system administrator for
                                                            the code.</small>
                                                    </div>
                                            ...
                                            <p class="text-center" style="color:#aaa;">
                                                ...
                                                <a href="${pageContext.request.contextPath}/login"
                                                    style="color:#e50914;">Login here</a>
                                            </p>
                        </div>
                    </div>
                </div>
