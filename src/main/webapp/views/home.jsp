                                                ...
                                                <c:forEach var="movie" items="${movies}">
                                                    <c:if test="${movie.status == 'coming_soon'}">
                                                        ...
                                                        <div class="col-6 col-md-3">
                                                            <a href="${pageContext.request.contextPath}/movies?action=detail&id=${movie.id}"
                                                                style="text-decoration:none; color:inherit;">
                                                                <div class="movie-card" style="border-color:#f39c12;">
                                                                    <c:choose>
                                                                        <c:when test="${not empty movie.posterPath}">
                                                                            <img src="${pageContext.request.contextPath}/${movie.posterPath}"
                                                                                alt="${movie.title}"
                      ...
                      font-weight:700; text-decoration:none; display:inline-block;">
                                    ...
                                    <%-- Services Section --%>
                                        <section class="services-section">
                                            <div class="container">
                                                <h2 class="section-title text-center">Why Choose <span>CineBook?</span>
                                                </h2>
                                                <div class="row g-4">
                                                    <div class="col-md-3">
                                                        <div class="service-card">
                                                            ...
                                                            <h5>Easy Booking</h5>
                                                            <p>Book tickets in just a few clicks from anywhere anytime.
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="service-card">
                                                            <div class="service-icon"><i class="bi bi-grid-3x3"></i>
                                                            </div>
                                                            <h5>Seat Selection</h5>
                                                            <p>Choose your preferred seats with our interactive seat
                                                                map.</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="service-card">
                                                            <div class="service-icon"><i class="bi bi-shield-check"></i>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4 mb-4">
                                                                <h4
                                                                    ...
                                                                    CineBook</h4>
                                                                <p class="mt-3">Your ultimate destination for movie
                                                                    ticket booking.
                                                                    Experience cinema like never before.</p>
                                                                <div class="mt-3">
                                                            ...
                                                            <div class="col-md-2 mb-4">
                                                                ...
                                                                <a
                                                                    ...
                                                                    <i class="bi bi-chevron-right"></i> Movies</a>
                                                                <a
                                                                    href="${pageContext.request.contextPath}/theater?action=shows">
                                                                    <i class="bi bi-chevron-right"></i> Shows</a>
                                                                <a
                                                                    href="${pageContext.request.contextPath}/booking?action=myBookings">
                                                                    <i class="bi bi-chevron-right"></i> Booking</a>
                                                                <a href="${pageContext.request.contextPath}/dashboard">
                                                                    <i class="bi bi-chevron-right"></i> Dashboard</a>
                                                            </div>
                                                            <div class="col-md-2 mb-4">
                                                                <h5>Account</h5>
                                                                <a href="${pageContext.request.contextPath}/login">
                                                                ...
                                                                <p>
                                                                    <a href="mailto:info@cinebook.lk"
                                                                        ...
                                                                        <i class="bi bi-envelope-fill"
                                                                            style="color:#e50914;"></i> info@cinebook.lk
                                                                    </a>
                                                                </p>
                                                            </div>
                                                        </div>
