                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav me-auto">
                                ...
                                <li class="nav-item"><a class="nav-link"
                                        href="${pageContext.request.contextPath}/movies?action=list">Movies</a></li>
                            ...
                            <ul class="navbar-nav">
                                <c:choose>
                                    <c:when test="${sessionScope.user != null}">
                                        ...
                                        <li class="nav-item"><a class="nav-link btn-login ms-2"
                                                href="${pageContext.request.contextPath}/logout">Logout</a></li>
                                    </c:when>
                                    <c:otherwise>
                                        <li class="nav-item"><a class="nav-link btn-login"
                                                href="${pageContext.request.contextPath}/login">Login</a></li>
                                        <li class="nav-item"><a class="nav-link btn-register-nav ms-2"
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-7">
                                    <p
                                        ...
                                        Welcome to CineBook</p>
                                    <h1>Experience <span>Cinema</span> Like Never Before</h1>
                                    <p>Book your favorite movie tickets online. Choose your seats, pick your showtime,
                            ...
                            <section class="movies-section" id="movies-section">
                                <div class="container">
                                    ...
                                    <c:choose>
                                                                    ...
                                                                    <c:forEach var="m" items="${movies}"
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <div class="movie-card">
                                                                                <c:choose>
                                                                                    <c:when
                                                                                        test="${not empty m.posterPath}">
                                                                                        <img src="${pageContext.request.contextPath}/${m.posterPath}"
                                                                                            alt="${m.title}">
                                                                                    </c:when>
                                                                                    <c:when
                                                                                        test="${not empty m.posterUrl}">
                                                                                        <img src="${m.posterUrl}"
                                                                                            alt="${m.title}"
                                                                                ...
                                                                                <div class="card-info">
                                                                                    <h6>${m.title}</h6>
                                                                                    <span
                                                                                        class="genre">${m.genre}</span><br>
                                                                                    <span
                                                                                        class="badge-status">${m.status}</span>
                                                                                    <div class="mt-2">
                                                                                        <a href="${pageContext.request.contextPath}/movies?action=detail&id=${m.id}"
                                                                                            class="btn btn-sm btn-outline-light w-100">View
                                                                                            Details</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                        ...
                                        <c:otherwise>
                                            <div class="text-center py-5">
                                                <p style="color:#aaa; font-size:1.2rem;">No movies available yet. Check
                                                    back soon!</p>
                                            </div>
                                        </c:otherwise>
                                    </c:choose>
                                    ...
                                    <div class="text-center">
                                        <a href="${pageContext.request.contextPath}/movies?action=list"
                                            class="btn btn-book">View All Movies</a>
                                    </div>
                                </div>
                            </section>
                                        ...
                                        <div class="row g-4">
                                            <div class="col-md-3">
                                                <div class="service-card">
                                                    <div class="service-icon"><i class="bi bi-ticket-perforated"></i>
                                                    </div>
                                                    <h5>Easy Booking</h5>
                                                    ...
                                                    <%-- Brand --%>
                                                        <div class="col-md-4 mb-4">
                                                            <h4
                                                                ...
                                                                CineBook</h4>
                                                            <p class="mt-3">Your ultimate destination for movie ticket
                                                                booking. Experience cinema like never before with our
                                                                easy and fast booking system.</p>
                                                            <div class="mt-3">
                                                        ...
                                                        <%-- Quick Links --%>
                                                            <div class="col-md-2 mb-4">
                                                                ...
                                                                <a
                                                                    href="${pageContext.request.contextPath}/movies?action=list"><i
                                                                        class="bi bi-chevron-right"></i> Movies</a>
                                                                <a href="#"><i class="bi bi-chevron-right"></i>
                                                                    Shows</a>
                                                                <a href="#"><i class="bi bi-chevron-right"></i>
                                                                    Booking</a>
                                                            ...
                                                            <%-- Account --%>
                                                                <div class="col-md-2 mb-4">
                                                                    ...
                                                                    <a
                                                                        ...
                                                                        Register</a>
                                                                    <a
                                                                        href="${pageContext.request.contextPath}/register?type=admin"><i
                                                                            class="bi bi-chevron-right"></i> Admin
                                                                        Register</a>
                                                                    <a
                                                                        href="${pageContext.request.contextPath}/dashboard"><i
                                                                            class="bi bi-chevron-right"></i> Profile</a>
                                                                </div>
                                                                ...
                                                                <%-- Theater & Contact --%>
                                                                    <div class="col-md-4 mb-4">
                                                                        ...
                                                                        <p><i class="bi bi-geo-alt-fill"
                                                                                style="color:#e50914;"></i> 123 Cinema
                                                                            Street, Colombo 03, Sri Lanka</p>
                                                                        <p><i class="bi bi-geo-alt-fill"
                                                                                style="color:#e50914;"></i> 456 Movie
                                                                            Avenue, Kandy, Sri Lanka</p>
                                                                        <p class="mt-2">
                                                                            <a href="tel:+94112345678"
                                                                                style="color:#aaa; text-decoration:none;">
                                                                                <i class="bi bi-telephone-fill"
                                                                                    style="color:#e50914;"></i> +94 11
                                                                                234 5678
                                                                            </a>
                                                                        </p>
                                                                        <p>
                                                                            <a href="tel:+94812345678"
                                                                                style="color:#aaa; text-decoration:none;">
                                                                                <i class="bi bi-telephone-fill"
                                                                                    style="color:#e50914;"></i> +94 81
                                                                                234 5678
                                                                            </a>
                                                                        </p>
                                                                        <p>
